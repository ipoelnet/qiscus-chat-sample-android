...
public class ChatWithStrangerDialogFragment  extends DialogFragment {
    ...
    private final com.qiscus.chat.ngobrel.ui.privatechatcreation.ChatWithStrangerDialogFragment.onStrangerNameInputtedListener listener;

    @SuppressLint("ValidFragment")
    public ChatWithStrangerDialogFragment(com.qiscus.chat.ngobrel.ui.privatechatcreation.ChatWithStrangerDialogFragment.onStrangerNameInputtedListener listener) {
